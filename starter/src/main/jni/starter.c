...
#define DEFAULT_PREFIX "/data/data/com.offsec.nhterm/files/usr"
...
Java_com_offsec_nhview_starter_Starter_checkXdgRuntimeDir(unused JNIEnv *env, unused jobject thiz) {
...
Java_com_offsec_nhview_starter_Starter_checkWaylandSocket(unused JNIEnv *env, unused jobject thiz) {
    int fd;
    errno = 0;
...
Java_com_offsec_nhview_starter_Starter_createWaylandSocket(unused JNIEnv *env, unused jobject thiz) {
    int fd;
    errno = 0;
...
JNIEXPORT jint JNICALL
Java_com_offsec_nhview_starter_Starter_openLogFD(unused JNIEnv *env, unused jobject thiz) {
...
JNIEXPORT void JNICALL
Java_com_offsec_nhview_starter_Starter_exec(JNIEnv *env, jclass clazz, jstring jpath, jobjectArray jargv) {
